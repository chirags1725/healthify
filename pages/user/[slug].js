...
export default function User() {
  ...
  useEffect(() => {
    sessionStorage.getItem("userdata")
      ...
      const setdata = data && data['test_values'].map((elem) => {
  ...
  //   console.log(prompt)
  //   const openai = new OpenAI({ apiKey: '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',dangerouslyAllowBrowser:true});
